...
describe('basic test', function () {
	...
	it('should load google.com', function (done) {
		...
		driver.wait(until.elementsLocated(By.id('LoginButton')))
		driver.findElement(By.id('LoginButton')).click()
		//driver.quit()
		  .then(_ => done())

  /*
	    .then(_ => driver.wait(until(ExpectedConditions.elementToBeClickable(By.id('phoneInput')))))
	    //.then(_ => driver.wait(until.titleIs('webdriver - Google Search'), 5000))
	    .then(_ => driver.quit())
	    .then(_ => done())
  */
	});
